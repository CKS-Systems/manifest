            ...
            <div className='w-full justify-center items-center max-w-[550px] 3xl:max-w-[800px] flex flex-col gap-6'>
              <div className='flex sm:gap-0 gap-4  flex-col w-full items-center lg:items-start '>
                <Slide direction='up' triggerOnce duration={800} delay={200}>
                  <p className='text-[14px] sm:text-[18px] 2xl:text-[22px] 3xl:text-[32px] font-normal text-[#95C9BD]'>
                    MISSION
                  </p>
                </Slide>
                <Slide direction='up' triggerOnce duration={800} delay={400}>
                  <h2 className='text-[20px] csm:text-[38px] 2xl:text-[48px] 3xl:text-[80px] mt-0 2xl:my-3 3xl:my-5 lg:text-left text-center font-terminaExtraDemi text-[#bca378] font-semibold leading-[30px] csm:leading-[58px] 2xl:leading-[70px] 3xl:leading-[105px]'>
              ...
              direction='right'
              duration={1000}
              className='sm:w-auto w-full flex lg:order-2 order-1 justify-center items-center xl:absolute mt-[6rem] xl:mt-0 xl:-top-[5rem] -right-0'
              triggerOnce
            >
                ...
                <div className='px-0 w-full sm:px-6 py-0 sm:py-6 flex flex-col borderGradientC1 justify-between lg:items-start items-center h-full'>
                  <div className='w-full flex flex-col gap-2'>
                    <h2 className='text-[26px] sm:text-[32px] sm:mt-2 md:mt-14 text-center lg:text-left xl:text-[48px] 2xl:text-[58px] 3xl:text-[75px] mt-12 lg:mt-[4rem] xl:mt-[8rem] tracking-[3px] text-[#bca378] font-terminaExtraDemi'>
                      Orderbook <br />
                      <span className='textColor'> DEX</span>
                    </h2>
                    ...
                    of Solana orderbooks allowing users to trade the price they want for free. Using limit orders increases liquidity and allows more exact risk expression than an AMM.
              ...
              >
                <div className='w-full flex md:justify-start justify-center items-center gap-4 sm:gap-4 mt-0 2xl:mt-4'>
                  <div className='bg-gradient-to-r from-[#927252] to-[#95C9BD] rounded-lg !p-[1px] 2xl:!p-[2px] 3xl:!p-[4px]'>
