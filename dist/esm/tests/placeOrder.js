...
export async function placeOrder(connection, payerKeypair, marketAddress, numBaseTokens, tokenPrice, isBid, orderType, clientOrderId, minOutTokens = 0, lastValidSlot = 0) {
