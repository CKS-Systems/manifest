 ...
 * @category generated
 */
export class QuoteAtomsPerBaseAtom {
    inner;
    constructor(inner) {
        this.inner = inner;
    }
    ...
    static gpaBuilder(programId = new web3.PublicKey('MNFSTqtC93rEfYHB6hF82sKdZpUDFWkViLByLd1k1Ms')) {
        return beetSolana.GpaBuilder.fromStruct(programId, quoteAtomsPerBaseAtomBeet);
    }
    /**
 ...
 * @category generated
 */
export const quoteAtomsPerBaseAtomBeet = new beet.BeetStruct([['inner', beet.u128]], QuoteAtomsPerBaseAtom.fromArgs, 'QuoteAtomsPerBaseAtom');
