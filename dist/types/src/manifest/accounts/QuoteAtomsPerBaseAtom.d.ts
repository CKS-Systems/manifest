 ...
 * @category generated
 */
export declare class QuoteAtomsPerBaseAtom implements QuoteAtomsPerBaseAtomArgs {
    readonly inner: beet.bignum;
    private constructor();
    /**
     * Creates a {@link QuoteAtomsPerBaseAtom} instance from the provided args.
     */
    static fromArgs(args: QuoteAtomsPerBaseAtomArgs): QuoteAtomsPerBaseAtom;
    /**
     * Deserializes the {@link QuoteAtomsPerBaseAtom} from the data of the provided {@link web3.AccountInfo}.
     * @returns a tuple of the account data and the offset up to which the buffer was read to obtain it.
     */
    static fromAccountInfo(accountInfo: web3.AccountInfo<Buffer>, offset?: number): [QuoteAtomsPerBaseAtom, number];
    /**
     ...
     */
    static fromAccountAddress(connection: web3.Connection, address: web3.PublicKey, commitmentOrConfig?: web3.Commitment | web3.GetAccountInfoConfig): Promise<QuoteAtomsPerBaseAtom>;
    /**
     ...
     * @returns a tuple of the account data and the offset up to which the buffer was read to obtain it.
     */
    static deserialize(buf: Buffer, offset?: number): [QuoteAtomsPerBaseAtom, number];
    /**
 ...
 * @category generated
 */
export declare const quoteAtomsPerBaseAtomBeet: beet.BeetStruct<QuoteAtomsPerBaseAtom, QuoteAtomsPerBaseAtomArgs>;
//# sourceMappingURL=QuoteAtomsPerBaseAtom.d.ts.map