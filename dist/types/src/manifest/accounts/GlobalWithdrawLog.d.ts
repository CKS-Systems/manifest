 ...
 * @category generated
 */
export declare class GlobalWithdrawLog implements GlobalWithdrawLogArgs {
     ...
     */
    static fromArgs(args: GlobalWithdrawLogArgs): GlobalWithdrawLog;
    /**
     * Deserializes the {@link GlobalWithdrawLog} from the data of the provided {@link web3.AccountInfo}.
     * @returns a tuple of the account data and the offset up to which the buffer was read to obtain it.
     */
    static fromAccountInfo(accountInfo: web3.AccountInfo<Buffer>, offset?: number): [GlobalWithdrawLog, number];
    /**
     ...
     */
    static fromAccountAddress(connection: web3.Connection, address: web3.PublicKey, commitmentOrConfig?: web3.Commitment | web3.GetAccountInfoConfig): Promise<GlobalWithdrawLog>;
    /**
     ...
     * @returns a tuple of the account data and the offset up to which the buffer was read to obtain it.
     */
    static deserialize(buf: Buffer, offset?: number): [GlobalWithdrawLog, number];
    /**
 ...
 * @category generated
 */
export declare const globalWithdrawLogBeet: beet.BeetStruct<GlobalWithdrawLog, GlobalWithdrawLogArgs>;
//# sourceMappingURL=GlobalWithdrawLog.d.ts.map